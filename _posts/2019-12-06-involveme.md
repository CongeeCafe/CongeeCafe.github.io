...
In conclusion, we believe that our App is able to achieve the goal we set out at the beginning of the term of increasing student engagement in volunteering by consolidating useful information into one central source. By going through each phase of the design process we were able to learn and get an appreciation for all the planning, designing and iterative updating it requires to develop a successful product. We learned that the design process involves consideration of many factors, including goals, audience, interface, and usability. Overall, this project was able to provide us with great insight on the many considerations that need to be taken in order to develop a successful product. If we were to re-do this project again, we would keep in mind these lessons and factor in the insights we gained at each phase of the design process into our initial decisions.